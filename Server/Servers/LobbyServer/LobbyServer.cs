...
namespace ZQ
{
    ...
    public class LobbyServer : Server
    {
        ...
        private ServerType m_serverType = ServerType.LobbyServer;
        ...
        protected override bool RegisterModules(string[] args)
        {
           ...
           // if (!AddModule<Lobby2MasterModule>(this, Config.masterIp, Config.masterPort)) return false;
            if (!AddModule<C2LobbyModule>(this, Config.externalIp, Config.externalPort)) return false;
