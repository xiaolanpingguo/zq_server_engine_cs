...
namespace ZQ
{
    public class Login2MasterComponent : IComponent
    {
        ...
        public Login2MasterComponent(string ip, ushort port)
        {
        ...
        public bool Init()
        {
            ...
            m_myServerInfo.ServerId = Game.Instance.LoginServerId;
            m_myServerInfo.ServerType = (short)ServerType.LoginServer;
            m_myServerInfo.PlayerNum = 0;
            m_myServerInfo.IP = Game.Instance.Config.login.externalIp;
            m_myServerInfo.Port = Game.Instance.Config.login.externalPort;
        ...
        private async Task ReportServerInfo()
        {
            ...
            Game.Instance.GetComponent<C2LoginComponent>().Start();
        }
        ...
        private async Task GetAllZoneServersAsync()
        {
            ...
            if (message is not L2M_AllZoneServersRes res)
            {
