...
namespace ZQ
{
    public class C2LoginComponent : IComponent
    {
        private const int k_connectionTimeout = 60 * 10;

        private TcpService m_service;
        private C2SMessageDispatcher m_messageDispatcher;
        private Login2MasterComponent m_login2MasterComponent;
        private RedisComponent m_redisComponent;

        private IPEndPoint m_endPoint;

        public C2LoginComponent(string ip, ushort port)
        {
        ...
        public bool Init() 
        {
            m_login2MasterComponent = Game.Instance.GetComponent<Login2MasterComponent>();
            m_redisComponent = Game.Instance.GetComponent<RedisComponent>();
        ...
        {
            if (message is not C2LLoginReq req)
            {
            ...
            do
            {
                ...
                if (dbResult.Item1 != C2S_ERROR_CODE.Success)
                {
